...
module.exports = async function handler(req, res) {
  ...
  try {
    const r = await fetch(
      `${SUPABASE_URL}/rest/v1/drope_products?select=id,slug,name,price_cents,qty_available,category,badge,image_url,image_status,hidden,descricao_quebrada,cores_predominantes,created_via,metadata,created_at&order=created_at.desc`,
